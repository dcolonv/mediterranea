...
export const serviceSchema = z.object({
  ...
  /** Calendar block length; 0/undefined = same as durationMinutes. */
  blockMinutes: z.number().int().min(0).optional().default(0),
  ...
  /** Limited-time / seasonal treatment (shows a badge). */
