...
export function AboutSnippet() {
  const { dict } = useLang();
  const values = [
    { title: dict.about.value1Title, description: dict.about.value1Desc, icon: ICONS[0] },
    { title: dict.about.value2Title, description: dict.about.value2Desc, icon: ICONS[1] },
    { title: dict.about.value3Title, description: dict.about.value3Desc, icon: ICONS[2] },
  ];
  return (
    <section
      id="about"
